...
namespace LeaveManagementWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            _userManager = userManager;       //DB de user olusturur
        ...
        {
            //returnUrl i kendi bu sayfaya ayarlar.
            ReturnUrl = returnUrl;
            ExternalLogins = (await _signInManager.GetExternalAuthenticationSchemesAsync()).ToList();
        }

        //Form Post edilinde yine bu sayfanın Url i çağrılır yani returnUrl 
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            //eger returnUrl null ise HomePage e dönder 
            ...
            if (ModelState.IsValid)     //eğer üstteki InputModel valid ise
            {
                ...
                // _userStore a user için  username ATA
                await _userStore.SetUserNameAsync(user, Input.Email, CancellationToken.None);
                // _emailStore a user için email adresi ATA
                await _emailStore.SetEmailAsync(user, Input.Email, CancellationToken.None);

                //Kendi ekledigimiz field ları başlatma
                ...
                {
                    //ModelState e kendi hatalarımızı bu şekilde ekleyebiliriz.
